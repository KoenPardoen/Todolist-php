        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="taskActions" style="width: 20%;">
                    ...
                    <span class="DltICon" style="float: right; padding-right: 15px;"><button type="submit" value="Delete" class=" trashIcon btn btn-link float-right"><i class="fas fa-trash-alt"></i></button></span>
                    {{ Form::close() }}
                </td>
            </tr>
            @endforeach
